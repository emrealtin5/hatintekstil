...
<!-- Mirrored from html.rrdevs.net/ribuild/index-2-one-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Jan 2025 23:28:07 GMT -->

<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Hatin Tekstil</title>
    <meta name="description" content="Hatin Tekstil">
...
<![endif]-->
    ...
    <!-- style 2 -->
    <div class="preloader" data-preloader="active" data-loaded="progress">
        <div class="wrapper w-100 text-center">
            <div id="progress-bar" class="preloader-text" data-text="HATİN TEKSTİL"></div>
                ...
                <div class="offcanvas__content">
                    <div class="offcanvas__top d-flex justify-content-between align-items-center">
                        <div class="offcanvas__logo">
                            <a href="index.php">
                                <img src="assets/imgs/logo/banner-logo.png" alt="logo not found">
                            </a>
                        </div>
                    ...
                    <div class="offcanvas__social">
                        <p class="mb-30">1975 yılında kurulan Hatin Tekstil, kaliteli ve güvenilir tekstil ürünleri ile evlere, iş yerlerine ve otellere hizmet vermektedir. Müşteri memnuniyetini ön planda tutarak, sürdürülebilir büyüme ve çevre dostu üretim ile sektörde lider bir konumdadır.</p>
                        <ul class="header-top-socail-menu d-flex">
                            <li><a href="https://www.linkedin.com/"><i class="fa-brands fa-linkedin-in"></i></a></li>
                            <li><a href="https://www.facebook.com/profile.php?id=134570770002554&_rdr"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="https://www.instagram.com/hatintekstil"><i class="fa-brands fa-instagram"></i></a></li>
                        </ul>
                    </div>
                    <div class="offcanvas__btn">
                        <div class="header__btn-wrap">
                            <a href="contact.php" class="rr-btn__header d-sm-none mb-10 w-100">
                                <span class="btn-wrap">
                                    <span class="text-one">İletişime Geçin</span>
                                    <span class="text-two">İletişime Geçin</span>
                                </span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xxl-6 col-5">
                            <ul class="header__top-menu d-flex">
                                <li>
                                    <a href="https://www.google.com/maps/place/Tekstil/@40.2785635,29.0516461,17z/data=!3m1!4b1!4m6!3m5!1s0x14ca415affc0a27d:0xcd39d1cd8fd33aee!8m2!3d40.2785635!4d29.0516461!16s%2Fg%2F11tdp4khd8?entry=ttu&g_ep=EgoyMDI0MTIxMS4wIKXMDSoASAFQAw%3D%3D">
                                        <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M14.7143 7.54545C14.7143 12.6364 7.85714 17 7.85714 17C7.85714 17 1 12.6364 1 7.54545C1 5.80949 1.72245 4.14463 3.00841 2.91712C4.29437 1.68961 6.03852 1 7.85714 1C9.67577 1 11.4199 1.68961 12.7059 2.91712C13.9918 4.14463 14.7143 5.80949 14.7143 7.54545Z" stroke="var(--rr-theme-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M7.857 9.72741C9.11937 9.72741 10.1427 8.75057 10.1427 7.54559C10.1427 6.3406 9.11937 5.36377 7.857 5.36377C6.59464 5.36377 5.57129 6.3406 5.57129 7.54559C5.57129 8.75057 6.59464 9.72741 7.857 9.72741Z" stroke="var(--rr-theme-primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        Alaşarköy, İstanbul Cd No:509, 16245 Osmangazi̇/Bursa
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-xxl-6 col-7">
                            <div class="header__top-menu__wrapper align-items-center d-flex justify-content-end">
                                ...
                                <ul class="header__top-menu d-flex justify-content-end">
                                    <li>
                                        <a href="#">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M15.9959 16L15.9999 15.9993V10.1313C15.9999 7.26065 15.3819 5.04932 12.0259 5.04932C10.4125 5.04932 9.32985 5.93465 8.88785 6.77399H8.84118V5.31732H5.65918V15.9993H8.97252V10.71C8.97252 9.31732 9.23652 7.97065 10.9612 7.97065C12.6605 7.97065 12.6859 9.55999 12.6859 10.7993V16H15.9959Z" fill="white" />
                                                <path d="M0.26416 5.31787H3.5815V15.9999H0.26416V5.31787Z" fill="white" />
                                                <path d="M1.92134 0C0.860668 0 0 0.860668 0 1.92134C0 2.982 0.860668 3.86067 1.92134 3.86067C2.982 3.86067 3.84267 2.982 3.84267 1.92134C3.842 0.860668 2.98134 0 1.92134 0Z" fill="white" />
                                            </svg>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="https://www.facebook.com/profile.php?id=134570770002554&_rdr">
                                            <svg width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path d="M5.84225 16V8.70218H8.49469L8.89264 5.85725H5.84225V4.04118C5.84225 3.21776 6.08893 2.65661 7.36946 2.65661L9 2.65599V0.111384C8.71802 0.0775563 7.75008 0 6.62351 0C4.27103 0 2.66048 1.32557 2.66048 3.75942V5.85725H0V8.70218H2.66048V16H5.84225Z" fill="white" />
                                                </g>
                                            </svg>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/hatintekstil">
                ...
                <div class="mega__menu-wrapper p-relative">
                    <div class="header__main">
                        <div class="header__logo">
                            <a href="index.php">
                                <div class="logo">
                                    <img class="img-fluid" src="assets/imgs/logo/banner-logo.png" alt="logo not found">
                                </div>
                            </a>
                        </div>

                        <div class="mean__menu-wrapper d-none d-lg-block">
                            <div class="main-menu main-menu-2 onepagenav">
                                <nav id="mobile-menu">
                                    <ul>
